...
streets = {
    ...
    "Проспект Ленина": {
        "markers": [
            {"name": "Проективное покрытие: 70%<br/>Высота газона: 0.3 см", "coords": [53.7213, 91.4334]},  # л
            {"name": "Проективное покрытие: 90%<br/>Высота газона: 0.3 см", "coords": [53.7211, 91.4334]},  # п
            {"name": "Проективное покрытие: 80%<br/>Высота газона: 0.3 см", "coords": [53.7213, 91.4337]},  # л
            {"name": "Проективное покрытие: 90%<br/>Высота газона: 0.3 см", "coords": [53.7221, 91.4337]},  # п
        ],
        "line": [
            [53.7211, 91.4333],
            [53.722755, 91.4495],
